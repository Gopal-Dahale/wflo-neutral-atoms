...
class MyBatch(BaseModel):
    ...
    configuration: Union[MyBaseConfig, Dict[str, Any], None] = None

    class Config:
        extra = Extra.allow
        arbitrary_types_allowed = True
        ignored_types = (MyResultType,)
    ...
    def _load_configuration(
        cls,
        configuration: Union[Dict[str, Any], MyBaseConfig, None],
        values: Dict[str, Any],
    ) -> Optional[MyBaseConfig]:
        if not isinstance(configuration, dict):
            return configuration
        conf_class: Type[MyBaseConfig] = MyBaseConfig
